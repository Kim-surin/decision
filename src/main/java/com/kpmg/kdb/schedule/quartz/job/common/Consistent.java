package com.kpmg.kdb.schedule.quartz.job.common;

public class Consistent {

	// 인터페이스 스케쥴(JOB) 변수
    public final static String IF_JOB_COMPANY_CODE = "COMPANY_CODE";          // 회사(법인)코드
    public final static String IF_JOB_SCHEDULE_CODE = "SCHEDULE_CODE";        // 스케쥴 코드
    ...
    public final static String IF_JOB_ALIAS_SCHEDULE_CODE = "ALIAS_SCHEDULE_CODE"; // 스케쥴의 임의명칭
    ...
    // 인터페이스 배치 변수
    public final static String IF_BATCH_INTERFACE_CODE = "IF_CODE";           // 실행할 인터페이스 코드(JCO코드)
    public final static String IF_BATCH_PARENT_CODE = "IF_PARENT_CODE";       // 상위 인터페이스 코드(JCO코드)
    ...
    public final static String IF_BATCH_HISTORY_TABLE = "HISTORY_TABLE";      // 임시 테이블 ex) INTG_INTERFACE_TRANS_DTL
    public final static String IF_BATCH_TRANS_PROGRAM_NAME = "TRANS_PROGRAM_NAME";	// 이관프로그램명
    public final static String IF_BATCH_PROCEDURE_ID = "TRANS_PROGRAM_ID";			// 실행 Procedure 명
        
    // 배치 처리상태 별수 
    public final static String IF_BATCH_TRANS_ID = "INTG_INTERFACE_TRANS_ID";	// 전송이력 번호
    public final static String IF_BATCH_INTERFACE_ID = "INTERFACE_ID";          // 자동배치 시 하나의 transaction을 식별하기 위한 ID
    public final static String IF_BATCH_TRANS_SEQ = "INTG_INTERFACE_ID";  		// 전송이력 row 순번
    ...
    public final static String IF_PARAMETER_TRANS_ID = "INTG_INTERFACE_TRANS_ID";// 전송이력 번호
    public final static String IF_PARAMETER_COMPANY_CODE = "COMPANY_CODE";    // 회사(법인)코드
    public final static String IF_PARAMETER_DIVISION_CODE = "DIVISION_CODE";  // 사업부 코드
    ...
    public final static String IF_PARAMETER_IF_CODE = "IF_CODE";              // 인터페이스 코드
    public final static String IF_PARAMETER_ITEM_CODE = "ITEM_CODE";          // 자재(또는 제품) 코드
    public final static String IF_PARAMETER_BATCH_FLAG = "BATCH_FLAG";        // 배치구분(D:일배치, M:월배치, W:주배치)
