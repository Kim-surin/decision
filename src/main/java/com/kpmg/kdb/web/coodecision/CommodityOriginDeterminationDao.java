 ...
 * {@link OriginDeterminationService#determineOrigin} 에 모으기 위해 옮겨왔다. CREATE_FCR
 * ({@link com.kpmg.kdb.web.createfcr.CreateFcrService})은 이제 FCR_MST/FCR_DTL 데이터 생성까지만
 * 담당한다.
 */
