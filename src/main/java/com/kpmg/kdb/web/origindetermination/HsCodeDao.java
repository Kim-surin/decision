...
import com.kpmg.kdb.web.origindetermination.dto.HsCodeBatchResult;
import com.kpmg.kdb.web.origindetermination.dto.HsCodeCandidateRow;
...
public interface HsCodeDao {
	 ...
	 * ({@link com.kpmg.kdb.web.origindetermination.HsCodeService#prefetchHsCode} 참고). 요청 조합마다 반드시
