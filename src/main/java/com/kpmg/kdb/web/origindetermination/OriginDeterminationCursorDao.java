...
import com.kpmg.kdb.web.origindetermination.dto.MaterialOriginRowBatchResult;
import com.kpmg.kdb.web.origindetermination.dto.MaterialOriginRowsRequest;
import com.kpmg.kdb.web.origindetermination.dto.OriginDeterminationTarget;
import com.kpmg.kdb.web.origindetermination.dto.OriginCriteria;
import com.kpmg.kdb.web.origindetermination.dto.OriginCriteriaBatchRequest;
import com.kpmg.kdb.web.origindetermination.dto.OriginCriteriaBatchResult;
 ...
 * 실제 오케스트레이션은 {@link OriginDeterminationExecutionService} 참고.
 *
 ...
 * {@link OriginDeterminationExecutionService} 뿐이라 같은 determineOrigin() 호출 안에서는 FM_LIST 행별
 * 삭제가 지울 대상이 이미 없었다.
 */
public interface OriginDeterminationCursorDao {
	 ...
	 * 분기 호출하기 위한 사전 확인용 — {@link OriginDeterminationExecutionService#determineOrigin} 참고.
	 */
	 ...
	 * 리스트를 반환하던 것과 동일 — {@link OriginDeterminationExecutionService} 참고).
	 */
	 ...
	 * 사전조회다(OriginDeterminationExecutionService#determineOrigin 참고).
	 */
