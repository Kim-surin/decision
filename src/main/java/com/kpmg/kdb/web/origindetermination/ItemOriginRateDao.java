...
import com.kpmg.kdb.web.origindetermination.dto.DivisionItemKey;
import com.kpmg.kdb.web.origindetermination.dto.ItemOriginRateCriteria;
import com.kpmg.kdb.web.origindetermination.dto.LastInputYyyyMmResult;
import com.kpmg.kdb.web.origindetermination.dto.MaterialBalanceRow;
import com.kpmg.kdb.web.origindetermination.dto.MaterialCandidatesBatchResult;
import com.kpmg.kdb.web.origindetermination.dto.MaterialCandidatesRequest;
import com.kpmg.kdb.web.origindetermination.dto.NonCertifiedOriginSummaryRequest;
import com.kpmg.kdb.web.origindetermination.dto.NonCertifiedOriginSummaryResult;
import com.kpmg.kdb.web.origindetermination.dto.PurchaseLedgerSummary;
import com.kpmg.kdb.web.origindetermination.dto.PurchaseLedgerSummaryBatchResult;
import com.kpmg.kdb.web.origindetermination.dto.PurchaseLedgerSummaryRequest;
...
public interface ItemOriginRateDao {
	 ...
	 * 조회하는 배치 버전. {@link com.kpmg.kdb.web.origindetermination.ItemOriginRateService#prefetchMaterialCandidates}
	 ...
	 * 조회하는 배치 버전. {@link com.kpmg.kdb.web.origindetermination.ItemOriginRateService#prefetchPurchaseLedgerSummaries}
	 ...
	 * 반복 호출되던 지점)에서 사용한다 — {@link com.kpmg.kdb.web.origindetermination.ItemOriginRateService#prefetchNonCertifiedOriginSummaries}
	 * 참고. 요청 목록에 없는 조합은 결과에 없다(호출자가 필요분만 넘긴다는 전제).
	 */
