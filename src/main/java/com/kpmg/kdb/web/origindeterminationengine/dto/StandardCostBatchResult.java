...
/**
 * {@link com.kpmg.kdb.web.origindeterminationengine.ItemPriceDao#selectStandardCostByDivisionBatch} 배치 조회 1건의
 * 결과. 매칭되는 STANDARD_COST 행이 없는 조합도 요청 키만 채워진 채 결과에 포함된다(나머지 필드는 null).
 */
