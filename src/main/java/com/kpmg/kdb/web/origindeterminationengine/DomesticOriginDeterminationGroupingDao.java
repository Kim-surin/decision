...
// 내수판정 대상 (companyCode,divisionCode,customerCode) 그룹 발견. DomesticOriginDeterminationTargetService가 사용한다.
public interface DomesticOriginDeterminationGroupingDao {
