...
public class ReportsPrintView {
	private static Log log = LogFactory.getLog(ReportsPrintView.class);
	...
	public void renderReport(HttpServletResponse response, Map param) throws Exception {
		byte bytes[];
