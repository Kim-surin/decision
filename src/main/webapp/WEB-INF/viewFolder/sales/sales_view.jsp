							...
							<div class="panel-container show">
								<div class="panel-content">
									<div class="row">
										...
										<div class="col-2">
											<div class="mb-3">
												<label class="form-label" for="example-select">고객사</label>
												<select class="form-select" id="customer_code">
										...
										<div class="col">
											<button type="button" onclick="javascript:SALESVIEW.retrieve_GridData();"
				...
				var SALESVIEW = new function () {
					...
					this.createAUIGrid = function () {
						const columnLayout = [
							...
							{dataField: "customer_name", headerText: "고객사", width: 200},
							{
							...
							{dataField: "export_flag", headerText: "내수/수출", width: 100}
						];
					...
					this.retrieve_GridData = function () {
						var params = {
							...
							, "customer_code": KpackageOBJ.object.getFormValue("SALES-form", "customer_code")
