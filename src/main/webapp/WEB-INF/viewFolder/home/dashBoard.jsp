	...
	<div class="content-wrapper">
		<div class="row">
			<div class="content-wrapper col-3">
				<h1 class="subheader-title mb-1">DASHBOARD</h1>
	    ...
	    <div class="row">
	    	<form:form id="DASHBOARD-form" class="s4-form" novalidate="novalidate" action="" method="post">
	    ...
	    <div class="row">
	   		<div class="col-12">
		        ...
		        <div id="oAuiGrid_Dashboard_01" style="width:100%;height:480px; margin:0 auto;"></div>
		    </div>
	    </div>	
	</div>
...
<script>
	var DASHBOARD = new function() {
		...
		this.Initialize_viewObject = function() {
			...
			// AUIGrid 그리드를 생성합니다.
			DASHBOARD.createAUIGrid();
			AUIGrid.setGridData(DASHBOARD.myGridID, DASHBOARD.data);
		}
		...
		this.createAUIGrid = function() {
			...
			DASHBOARD.myGridID = AUIGrid.create("#oAuiGrid_Dashboard_01", columnLayout,
					gridProps);
		}
	}
	$(document).ready(function() {
		pageSetUp(); // 위젯 기능을 사용하기 위해 필수로 호출 합니다.
		DASHBOARD.Initialize_viewObject();
	});
</script>
