...
<body>
    <div class="modal-header py-2 px-3">
	    <h5 class="modal-title fs-5 fw-semibold mb-0">증명서 발급</h5>
    ...
    <div class="modal-body">
        <form:form id="COO_ISSUE_CERT_POPUP-form" method="post" action="" novalidate="novalidate">
            ...
            <input type="hidden" id="cover_yn" name="cover_yn"/> <!-- 포괄여부  -->
            <input type="hidden" id="export_flag" name="export_flag" value="E"/>
            <input type="hidden" id="coo_type" name="coo_type" value="N"/>
                ...
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex gap-2">
			                <button type="button" class="btn btn-outline-primary btn-sm px-4" onclick="COO_ISSUE_CERT_POPUP.issueConfirm();">
			                    발급
			                </button>
			            </div>
                    </div>
                    ...
                    <div class="row g-2 align-items-end">
                            ...
                            <div class="border rounded-3 p-2 bg-light-subtle h-100">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <button type="button" id="btn_check_duplicate" class="btn btn-outline-secondary" onclick="COO_ISSUE_CERT_POPUP.checkDuplicateCertifyNo();">
                                            중복확인
                                        </button>
                                    </div>
                        ...
                        <div class="col-4">
                            <div id="div_cert_cert_date" class="border rounded-3 p-2 h-100">
                                <label class="form-label fw-semibold small mb-1">포괄기간</label>
                                <div class="d-flex align-items-center gap-1">
                                    <input type="date" id="cert_from_date" name="cert_from_date" class="form-control form-control-sm">
                                    <span class="text-secondary small">~</span>
                                    <input type="date" id="cert_to_date" name="cert_to_date" class="form-control form-control-sm">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div id="oAuiGrid_COO_ISSUE_CERT_POPUP_01" style="width:100%; height:490px; margin:0 auto;"></div>
            </div>
        </div>
    </div>
	...
	<script>
	    var COO_ISSUE_CERT_POPUP = new function() {
	        ...
	        this.setDefaultIssueDate = function() {
	        	...
	        	COO_ISSUE_CERT_POPUP.needAutoCheckAfterLoad = true;
	            ...
	            KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "issue_date", yyyy + "-" + mm + "-" + dd);
	        ...
	        this.setDefaultValue = function() {
	            ...
	            /* 문서 기본정보 설정 */
	            KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "invoice_date", params["invoice_date"]);
	            KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "cover_yn", params["cover_yn"]);
	            //COVER_YN 값 체크
	            if("Y" == params["cover_yn"]){
	            	// 증명서이면서 포괄인경우 
	            	$("#div_cert_cert_date").show();	
	            }else{
	            	$("#div_cert_cert_date").hide();	
	            }
	            ...
	            KpackageOBJ.selectbox.create("COO_ISSUE_CERT_POPUP-form", "signature_seq", "/common/retrieveSignatureCombo", comboParam, "code", "name");
	            ...
	            params["salesList"] = salesList;
	
	            KpackageOBJ.auiGrid.retrieve(
	                COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01, "/issuecert/retrieveCooIssueTargetList", params );
	        };
	        ...
	        this.createAUIGrid = function() {
	        	const columnLayout = [
	                ...
	                /* 숨김 컬럼 */
	                { dataField: "coo_certify_no", visible: false },
	                { dataField: "co_issue_flag", visible: false },
	                { dataField: "division_code", visible: false },
	                { dataField: "new_certify_no", visible: false },
	                { dataField: "cert_date", visible: false },
	                { dataField: "company_coo_yn",    headerText: "회사기준",    width: 90,    style: "aui-center",    visible: false},
					{ dataField: "division_name",    headerText: "플랜트",    width: 100,    style: "aui-center",    visible: false},
					{ dataField: "fta_code",    headerText: "FTA CODE",    width: 110,    style: "aui-center",    visible: false},
					{ dataField: "sales_no",    headerText: "매출번호",    width: 140,    style: "aui-center",    visible: false},
					{ dataField: "sales_seq",    headerText: "순번",    width: 70,    style: "aui-center",    visible: false},
					{ dataField: "fta_coo_yn",    headerText: "FTA기준",    width: 90,    style: "aui-center",    visible: false},
					{ dataField: "coo_date",    headerText: "판정일",    width: 110,    style: "aui-center",    visible: false},
					{ dataField: "department_code",    headerText: "부서코드",    width: 100,    style: "aui-center",    visible: false},
					{ dataField: "bl_no",    headerText: "B/L NO",    width: 120,    style: "aui-center",    visible: false}
	            ...
	            const gridProps = {
	    			...
	    			rowStyleFunction: function(rowIndex, item) {
	    	            var checkedRows = AUIGrid.getCheckedRowItems(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01);
	            ...
	            COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01 =
	                KpackageOBJ.auiGrid.create("oAuiGrid_COO_ISSUE_CERT_POPUP_01", columnLayout, gridProps, "check");
	
	            

	            AUIGrid.bind(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01, "rowCheckClick", function() {
	                AUIGrid.refresh(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01);
	            });

	            AUIGrid.bind(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01, "rowAllCheckClick", function() {
	                AUIGrid.refresh(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01);
	            });
	            
	            /* 데이터 로드가 완료되면 */
	            AUIGrid.bind(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01, "ready", function (event) {
	            	if (!COO_ISSUE_CERT_POPUP.needAutoCheckAfterLoad) {
	                    return;
	                }

	                COO_ISSUE_CERT_POPUP.needAutoCheckAfterLoad = false;
	                COO_ISSUE_CERT_POPUP.autoCheckPriorityRows();
	        ...
	        this.checkDuplicateCertifyNo = function() {
	            ...
	            var certifyNo = KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "coo_certify_no"); 
	              
	            if (!certifyNo) {
	                alert("원산지증명서 번호를 입력하세요.");
	                $("#coo_certify_no").focus();
	                return;
	            }
	            
	            var checkedItems = AUIGrid.getCheckedRowItems(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01);
	            
	            var params = { coo_certify_no : certifyNo
	            		       ,division_code : checkedItems[0]["item"]["division_code"]
	            };
	            KpackageOBJ.ajax.doSubmit("/issuecert/checkDuplicateCertifyNo", params, (result) => {
	                if(result.success){
	                	alert("사용가능한 증명서 번호 입니다.");
	                	COO_ISSUE_CERT_POPUP.isCertifyNoChecked = true;
	                }else{
	                	alert("중복된 증명서 번호 입니다.");
	                	COO_ISSUE_CERT_POPUP.isCertifyNoChecked = false;
	                }
	        ...
	        this.issueConfirm = function() {
	        	...
	        	var signatureSeq  = KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "signature_seq");
	        	var issueDate     = KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "issue_date");
	        	var certFromDate = KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "cert_from_date");
	        	var certToDate   = KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "cert_to_date");
	        	var cooCertifyNo  = KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "coo_certify_no");
	            ...
	            // 5. 포괄기간 1년 초과 체크
	            var fromDate = new Date(certFromDate);
	            var toDate = new Date(certToDate);
	            ...
	            if (!autoCreateYn) {
	                if (!cooCertifyNo) {
	                    alert("원산지증명서 번호를 입력해주세요.");
	                    $("#coo_certify_no").focus();
	                    return;
	                }

	                if (!COO_ISSUE_CERT_POPUP.isCertifyNoChecked) {
	                    alert("원산지증명서 번호 중복확인을 해주세요.");
	            ...
	            var allRows = AUIGrid.getGridData(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01);
	            var warningFtaNames = [];
	            ...
	            var params = KpackageOBJ.data.makePostData("COO_ISSUE_CERT_POPUP-form");   
	            params["coo_issue_cert_target"] = issueTargetList;
	            params["division_code"] = issueTargetList[0]["division_code"];
	        
	            KpackageOBJ.ajax.doSubmit("/issuecert/confirmIssue", params, (result) => {
	                var data = result.value || {};
	                
	             	// 발급이 성공적으로 수행된 후 
		            // 기존 발급 페이지는 닫힘
		            KpackageOBJ.sidepanel.close("cooIssueCertForm");

	                if(result.success){
	                	setTimeout(function() {
	                		//증명서 상세 페이지 (추후 개발 예정) 팝업이 열림
	                		var getParam = "?coo_certify_no=" + encodeURIComponent(data)  // 새로운 증명서 번호 
                					+ "&customer_code=" +  KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "customer_code");
	        ...
	        this.toggleCertifyNoInput = function() {
	            ...
	            if (checked) {
	                KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "coo_certify_no", "");
	        ...
	        this.syncCoverPeriodByIssueDate = function() {
	        	if("Y" == KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "cover_yn")){
	        		var issueDate = KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "issue_date");
	        		
		            if (!issueDate) {
		            	KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "cert_from_date", "");
			            KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "cert_to_date", "");
		            ...
		            KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "cert_from_date", issueDate);
		            KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "cert_to_date", year + "-12-31");	
	        	}else{
	        		var invoice_date = KpackageOBJ.object.getFormValue("COO_ISSUE_CERT_POPUP-form", "invoice_date");
	        		KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "cert_from_date", invoice_date);
		            KpackageOBJ.object.setFormValue("COO_ISSUE_CERT_POPUP-form", "cert_to_date", invoice_date);
	        	}
	        ...
	        this.bindEvent = function() {
	            $("#auto_create_yn").off("change").on("change", function() {
	                COO_ISSUE_CERT_POPUP.toggleCertifyNoInput();
	            });
	
	            $("#issue_date").off("change").on("change", function() {
	                COO_ISSUE_CERT_POPUP.syncCoverPeriodByIssueDate();
	            });
	        ...
	        this.autoCheckPriorityRows = function() {
	            var gridData = AUIGrid.getGridData(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01);
	            ...
	            AUIGrid.setCheckedRowsByIds(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01, checkedRowIds);
	            /* 배경색 즉시 반영 */
	            setTimeout(function() {
	                AUIGrid.refresh(COO_ISSUE_CERT_POPUP.grid_COO_ISSUE_CERT_POPUP_01);
	            }, 50);
	    ...
	    $(document).ready(function() {
	        COO_ISSUE_CERT_POPUP.Initialize_viewObject();
	    });
	</script>
</body>
</html>