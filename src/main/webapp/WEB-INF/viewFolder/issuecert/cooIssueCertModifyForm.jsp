...
<body>
    <div class="modal-header py-2 px-3">
	    <h5 class="modal-title fs-5 fw-semibold mb-0">증명서 수정발급</h5>
    ...
    <div class="modal-body">
        <form:form id="COO_CERT_MODIFY_POPUP-form" method="post" action="" novalidate="novalidate">
            ...
            <input type="hidden" id="origin_coo_certify_no" name="origin_coo_certify_no" value="${origin_coo_certify_no}"/>
                ...
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
					    ...
					    <div class="d-flex align-items-center gap-2">
					        <label for="modify_issue_reason" class="fw-semibold mb-0 text-nowrap">수정발급사유</label>
					        <input type="text"
					               id="modify_issue_reason"
					               name="modify_issue_reason"
					        ...
					        <button type="button"
					                ...
					                onclick="COO_CERT_MODIFY_POPUP.issueConfirm();">
					            수정발급
					        </button>
					    </div>
					</div>
                    ...
                    <div class="row g-2 align-items-end">
                            ...
                            <div class="border rounded-3 p-2 bg-light-subtle h-100">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <button type="button" id="btn_check_duplicate" class="btn btn-outline-secondary" onclick="COO_CERT_MODIFY_POPUP.checkDuplicateCertifyNo();">
                                            중복확인
                                        </button>
                                    </div>
                        ...
                        <div class="col-4">
                            <div id="div_coverModify_Date_FromTo" class="border rounded-3 p-2 h-100">
        ...
        <div class="row">
            <div class="col-12">
                <div id="oAuiGrid_COO_CERT_MODIFY_POPUP_01" style="width:100%; height:490px; margin:0 auto;"></div>
            </div>
        </div>
    </div>

	<script>
	    var COO_CERT_MODIFY_POPUP = new function() {
	
	        this.grid_COO_CERT_MODIFY_POPUP_01 = null;
	        //최초 1회 실행용
	        ...
	        this.Initialize_viewObject = function() {
	            ...
	            this.syncCertPeriodByIssueDate();
	        };
	
	        this.setDefaultIssueDate = function() {
	        	
	        	COO_CERT_MODIFY_POPUP.needAutoCheckAfterLoad = true;
	            ...
	            KpackageOBJ.object.setFormValue("COO_CERT_MODIFY_POPUP-form", "issue_date", yyyy + "-" + mm + "-" + dd);
	        };
	        ...
	        this.setDefaultValue = function() {
	            ...
	            let comboParam = {
	                "OPTION_ALL": "Y",
	                "invoice_date": KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "invoice_date")
	            
	            };
	            KpackageOBJ.selectbox.create("COO_CERT_MODIFY_POPUP-form", "signature_seq", "/common/retrieveSignatureCombo", comboParam, "code", "name");
	
	            let params = KpackageOBJ.data.makePostData ("COO_CERT_MODIFY_POPUP-form");
	            ...
	            /* 증명서 발급 대상 조회 */
	            KpackageOBJ.ajax.doSubmit("/issuecert/retrieveCooModifyCertList", params, (result) => {
	                var value = result.value || {};
	                var salesList = [];
	                for (var i = 0; i < value.length; i++) {
		                var row = value[i].item ? value[i].item : value[i];
		            ...
		            KpackageOBJ.auiGrid.retrieve(
		                COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01,
		                "/issuecert/retrieveCooIssueTargetList",
		                salesParams
		            );
	            });
	        ...
	        this.createAUIGrid = function() {
	            ...
	            const gridProps = {
	    			...
	    			rowStyleFunction: function(rowIndex, item) {
	    	            var checkedRows = AUIGrid.getCheckedRowItems(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01);
	            ...
	            COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01 =
	                KpackageOBJ.auiGrid.create("oAuiGrid_COO_CERT_MODIFY_POPUP_01", columnLayout, gridProps, "check");
	
	            

	            AUIGrid.bind(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01, "rowCheckClick", function() {
	                AUIGrid.refresh(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01);
	            });

	            AUIGrid.bind(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01, "rowAllCheckClick", function() {
	                AUIGrid.refresh(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01);
	            });
	            
	            /* 데이터 로드가 완료되면 */
	            AUIGrid.bind(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01, "ready", function (event) {
	            	if (!COO_CERT_MODIFY_POPUP.needAutoCheckAfterLoad) {
	                    return;
	                }

	                COO_CERT_MODIFY_POPUP.needAutoCheckAfterLoad = false;
	                COO_CERT_MODIFY_POPUP.autoCheckPriorityRows();
	                
	                
					var gridDataList = KpackageOBJ.auiGrid.getGridData(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01);
	            	
	            	if(gridDataList.length > 0){
	            		var rowData = KpackageOBJ.auiGrid.getGridData(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01)[0];
		            	var coverYn = rowData.cover_yn;
		            	
		            	if("Y" != coverYn){
		            		$("#div_coverModify_Date_FromTo").hide();
		            	}
	            	}
	        ...
	        this.checkDuplicateCertifyNo = function() {
	            ...
	            var certifyNo = KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "coo_certify_no"); 
	            ...
	            var checkedItems = AUIGrid.getCheckedRowItems(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01);
	            ...
	            KpackageOBJ.ajax.doSubmit("/issuecert/checkDuplicateCertifyNo", params, (result) => {
	                if(result.success){
	                	...
	                	COO_CERT_MODIFY_POPUP.isCertifyNoChecked = true;
	                }else{
	                	alert("중복된 증명서 번호 입니다.");
	                	COO_CERT_MODIFY_POPUP.isCertifyNoChecked = false;
	                }
	        ...
	        this.issueConfirm = function() {
	            ...
	            var signatureSeq  = KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "signature_seq");
	            var issueDate     = KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "issue_date");
	            var certFromDate = KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "cert_from_date");
	            var certToDate   = KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "cert_to_date");
	            var cooCertifyNo  = KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "coo_certify_no");
	            ...
	            if (!autoCreateYn) {
	                ...
	                if (!COO_CERT_MODIFY_POPUP.isCertifyNoChecked) {
	            ...
	            var allRows = AUIGrid.getGridData(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01);
	            var warningFtaNames = [];
	            ...
	            var params = KpackageOBJ.data.makePostData("COO_CERT_MODIFY_POPUP-form");
	            params["coo_issue_cert_target"] = issueTargetList;
	            params["division_code"] = issueTargetList[0]["division_code"];
	            params["program_id"] = "cooIssueCertModifyForm";

	            /* 수정발급 사유 입력 */
	            var modifyIssueReason = KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "modify_issue_reason");
	            if (!modifyIssueReason || $.trim(modifyIssueReason) === "") {
	                alert("수정발급사유를 입력해주세요.");
	                $("#modify_issue_reason").focus();
	                return;
	            }
	            
	            KpackageOBJ.ajax.doSubmit("/issuecert/confirmIssue", params, function(result) {
                    var data = result.value || {};

                    KpackageOBJ.sidepanel.close("cooIssueCertModifyForm");

                    if (result.success) {
                        setTimeout(function() {
                            var getParam = "?coo_certify_no=" + encodeURIComponent(data)
                                         + "&customer_code=" + KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "customer_code");

                            KpackageOBJ.sidepanel.open(
                                "cooIssueDetailPopup",
                                "/issuecert/cooIssueCertDetail" + getParam,
                                "1300px",
                                true
                            );
	        ...
	        this.toggleCertifyNoInput = function() {
	            ...
	            if (checked) {
	                ...
	                KpackageOBJ.object.setFormValue("COO_CERT_MODIFY_POPUP-form", "coo_certify_no", "");
	                $("#COO_CERT_MODIFY_POPUP-form #coo_certify_no").addClass("bg-body-secondary text-secondary");
	            } else {
	                $("#COO_CERT_MODIFY_POPUP-form #coo_certify_no").removeClass("bg-body-secondary text-secondary");
	            }
	        };
	
	        /* 발급일자 기준 포괄기간 */
	        this.syncCertPeriodByIssueDate = function() {
	            var issueDate = KpackageOBJ.object.getFormValue("COO_CERT_MODIFY_POPUP-form", "issue_date");
	
	            if (!issueDate) {
	            	KpackageOBJ.object.setFormValue("COO_CERT_MODIFY_POPUP-form", "cert_from_date", "");
	            	KpackageOBJ.object.setFormValue("COO_CERT_MODIFY_POPUP-form", "cert_to_date", "");
	                return;
	            }
	
	            var year = issueDate.substring(0, 4);
	
	            KpackageOBJ.object.setFormValue("COO_CERT_MODIFY_POPUP-form", "cert_from_date", issueDate);
            	KpackageOBJ.object.setFormValue("COO_CERT_MODIFY_POPUP-form", "cert_to_date", year + "-12-31");
            	
	        };
	
	        this.bindEvent = function() {
	            $("#auto_create_yn").off("change").on("change", function() {
	                COO_CERT_MODIFY_POPUP.toggleCertifyNoInput();
	            });
	
	            $("#issue_date").off("change").on("change", function() {
	                COO_CERT_MODIFY_POPUP.syncCertPeriodByIssueDate();
	            });
	        ...
	        this.autoCheckPriorityRows = function() {
	            var gridData = AUIGrid.getGridData(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01);
	            ...
	            AUIGrid.setCheckedRowsByIds(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01, checkedRowIds);
	            /* 배경색 즉시 반영 */
	            setTimeout(function() {
	                AUIGrid.refresh(COO_CERT_MODIFY_POPUP.grid_COO_CERT_MODIFY_POPUP_01);
	            }, 50);
	    ...
	    $(document).ready(function() {
	        COO_CERT_MODIFY_POPUP.Initialize_viewObject();
	    });
	</script>
</body>
</html>