...
<div id="content">
	<section id="widget-grid" class="">
		<form:form id="R007-form" class="s4-form" novalidate="novalidate" action="/report-006" method="post">
			<div class="row-extends row">
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="text" id="SEARCH_STDR_MT"  name="SEARCH_STDR_MT"  class="inputText has-month-picker" searchfnc="R007.retrieve_R007List"/>
									</td>
									...
									<td>
										...
										<input type="text" id="SEARCH_KEY_WORD" name="SEARCH_KEY_WORD" class="inputText" searchfnc="R007.retrieve_R007List"/>
									</td>
									<th><spring:message code='실적상태' /></th>
									<td>
				...
				<div class="col-xs-12 col-sm-1 col-md-1 col-lg-1">
					<div class="input-group-btn">
						<button class="btn btn-default btn-primary btn-custom-search search-row-1" type="button" onclick="javascript:R007.retrieve_R007List();">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div id="div_oTui_R007_List" name="div_oTui_R007_List" class="tuigrid-resizable">
					<div id="oTui_R007_List" data-minus-height="250"></div>
					<div id="oTui_R007_List_paging"></div>
				</div>
			</div>
		</div>
...
<script>
	...
	var R007 = new function(){
		...
		this.Initialize_viewObject = function() {
			...
			KpackageOBJ.monthPicker.create("R007-form", "SEARCH_STDR_MT");
			KpackageOBJ.monthPicker.setValue("R007-form","SEARCH_STDR_MT", fromDay);		
	
			/*Search Type Select Box Create */
			arrayItem = [{value:"REPRSNT_CUSTOMER_CODE", name:"<spring:message code='자재코드'/>"}
						,{value:"CSTMR_ITEM", name:"<spring:message code='자재내역'/>"}
						,{value:"CSTMR_ITEM", name:"<spring:message code='자재유형'/>"}
						];
			
			KpackageOBJ.selectbox.create("R007-form", "SEARCH_TYPE", "", null, "value", "name", arrayItem);
			...
			KpackageOBJ.selectbox.create("R007-form", "SEARCH_OPTION", "", null, "value", "name", arrayItem);
			
			var arrayItem = [{value:"", name:"<spring:message code='common.title.all'/>"}
							,{value:"Y", name:"<spring:message code='정상'/>"}
	        				,{value:"N", name:"<spring:message code='오류'/>"}];

			KpackageOBJ.selectbox.create("R007-form", "SEARCH_YN", "", null, "value", "name", arrayItem);
		...
		this.renderTuiGrid = function() {
			 ...
			 KpackageOBJ.tuiGrid.create("oTui_R007_List", "/report/retrieve_R007List", colArrayInfo, "number", null);
			 
		}
		
		this.retrieve_R007List = function() {
			
			var param = { "STDR_MT" : KpackageOBJ.object.getFormValue("R007-form", "SEARCH_STDR_MT")
						, "SEARCH_TYPE" : KpackageOBJ.object.getFormValue("R007-form","SEARCH_TYPE")
					 	, "SEARCH_KEY_WORD" : KpackageOBJ.object.getFormValue("R007-form", "SEARCH_KEY_WORD")
			         	, "SEARCH_OPTION" : KpackageOBJ.object.getFormValue("R007-form","SEARCH_OPTION")
						};
			
			//KpackageOBJ.tuiGrid.retrieve("oTui_R007_List", "/report/retrieve_R007List", param);
	...
	$(document).ready(function() {
		...
		R007.Initialize_viewObject();		// 화면에서 사용하는 Selelect Box, Calendar 등을 생성합니다. 
	});
</script>
</body>
</html>