...
var ISSUE_TARGET = new function() {
    ...
    this.setDefaultMonth = function() {
        ...
        $("#from_yyyymm").val(currentMonth);
        $("#to_yyyymm").val(currentMonth);
    };
    
    this.setMonthRange = function(monthCount) {
        let fromValue = $("#from_yyyymm").val();
        ...
        $("#from_yyyymm").val(fromY + "-" + fromM);
        $("#to_yyyymm").val(toY + "-" + toM);
    };
    ...
    */
    this.openCooIssueDialog = function(){
        ...
        KpackageOBJ.sidepanel.open('cooIssueCoverForm','/issuecover/cooIssueCoverForm' + getParam, '1300px');
    }
    ...
    this.drawTopChart = function(){
		var params = KpackageOBJ.data.makePostData("ISSUE_TARGET-form");
