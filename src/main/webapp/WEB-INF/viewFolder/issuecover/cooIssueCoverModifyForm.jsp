...
<body>
    <div class="modal-header py-2 px-3">
	    <h5 class="modal-title fs-5 fw-semibold mb-0">확인서 수정발급</h5>
    ...
    <div class="modal-body">
        <form:form id="COO_MODIFY_POPUP-form" method="post" action="" novalidate="novalidate">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
					    ...
					    <div class="d-flex align-items-center gap-2">
					        ...
					        <button type="button"
					                ...
					                onclick="COO_MODIFY_POPUP.issueConfirm();">
					            수정발급
					        </button>
					    </div>
					</div>
                            ...
                            <div class="border rounded-3 p-2 bg-light-subtle h-100">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <button type="button" id="btn_check_duplicate" class="btn btn-outline-secondary" onclick="COO_MODIFY_POPUP.checkDuplicateCertifyNo();">
                                            중복확인
                                        </button>
                                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div id="oAuiGrid_COO_MODIFY_POPUP_01" style="width:100%; height:490px; margin:0 auto;"></div>
            </div>
        </div>
    </div>

	<script>
	    var COO_MODIFY_POPUP = new function() {
	
	        this.grid_COO_MODIFY_POPUP_01 = null;
	        //최초 1회 실행용
	        ...
	        this.setDefaultIssueDate = function() {
	        	...
	        	COO_MODIFY_POPUP.needAutoCheckAfterLoad = true;
	        ...
	        this.setDefaultValue = function() {
	            ...
	            let comboParam = {
	                "OPTION_ALL": "Y",
	                "invoice_date": KpackageOBJ.object.getFormValue("COO_MODIFY_POPUP-form", "invoice_date")
	            
	            };
	            KpackageOBJ.selectbox.create("COO_MODIFY_POPUP-form", "signature_seq", "/common/retrieveSignatureCombo", comboParam, "code", "name");
	
	            let params = KpackageOBJ.data.makePostData ("COO_MODIFY_POPUP-form");
	            ...
	            /* 확인서 발급 대상 조회 */
	            KpackageOBJ.ajax.doSubmit("/issuecover/retrieveCooModifyCoverList", params, (result) => {
	                var value = result.value || {};
	                var salesList = [];
		            ...
		            KpackageOBJ.auiGrid.retrieve(
		                COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01,
	        ...
	        this.createAUIGrid = function() {
	            ...
	            const gridProps = {
	    			...
	    			rowStyleFunction: function(rowIndex, item) {
	    	            var checkedRows = AUIGrid.getCheckedRowItems(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01);
	            ...
	            COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01 =
	                KpackageOBJ.auiGrid.create("oAuiGrid_COO_MODIFY_POPUP_01", columnLayout, gridProps, "check");
	
	            

	            AUIGrid.bind(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01, "rowCheckClick", function() {
	                AUIGrid.refresh(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01);
	            });

	            AUIGrid.bind(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01, "rowAllCheckClick", function() {
	                AUIGrid.refresh(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01);
	            });
	            
	            /* 데이터 로드가 완료되면 */
	            AUIGrid.bind(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01, "ready", function (event) {
	            	if (!COO_MODIFY_POPUP.needAutoCheckAfterLoad) {
	                    return;
	                }

	                COO_MODIFY_POPUP.needAutoCheckAfterLoad = false;
	                COO_MODIFY_POPUP.autoCheckPriorityRows();
	                AUIGrid.refresh(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01);
	            });
	            setTimeout(function() {
	        ...
	        this.checkDuplicateCertifyNo = function() {
	            ...
	            var certifyNo = KpackageOBJ.object.getFormValue("COO_MODIFY_POPUP-form", "coo_certify_no"); 
	            ...
	            var checkedItems = AUIGrid.getCheckedRowItems(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01);
	            ...
	            KpackageOBJ.ajax.doSubmit("/issuecover/checkDuplicateCertifyNo", params, (result) => {
	                if(result.success){
	                	...
	                	COO_MODIFY_POPUP.isCertifyNoChecked = true;
	                }else{
	                	alert("중복된 확인서 번호 입니다.");
	                	COO_MODIFY_POPUP.isCertifyNoChecked = false;
	                }
	        ...
	        this.issueConfirm = function() {
	            ...
	            var signatureSeq  = KpackageOBJ.object.getFormValue("COO_MODIFY_POPUP-form", "signature_seq");
	            var issueDate     = KpackageOBJ.object.getFormValue("COO_MODIFY_POPUP-form", "issue_date");
	            var coverFromDate = KpackageOBJ.object.getFormValue("COO_MODIFY_POPUP-form", "cover_from_date");
	            var coverToDate   = KpackageOBJ.object.getFormValue("COO_MODIFY_POPUP-form", "cover_to_date");
	            var cooCertifyNo  = KpackageOBJ.object.getFormValue("COO_MODIFY_POPUP-form", "coo_certify_no");
	            ...
	            if (!autoCreateYn) {
	                ...
	                if (!COO_MODIFY_POPUP.isCertifyNoChecked) {
	            ...
	            var allRows = AUIGrid.getGridData(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01);
	            var warningFtaNames = [];
	            ...
	            var params = KpackageOBJ.data.makePostData("COO_MODIFY_POPUP-form");
	            params["coo_issue_target"] = issueTargetList;
	            params["division_code"] = issueTargetList[0]["division_code"];
	            params["program_id"] = "cooIssueCoverModifyForm";

	            /* 수정발급 사유 입력 */
	            var modifyIssueReason = KpackageOBJ.object.getFormValue("COO_MODIFY_POPUP-form", "modify_issue_reason");
	            ...
	            KpackageOBJ.ajax.doSubmit("/issuecover/confirmIssue", params, function(result) {
                    var data = result.value || {};

                    KpackageOBJ.sidepanel.close("cooIssueCoverModifyForm");
                    ...
                    if (result.success) {
                        setTimeout(function() {
                            ...
                            KpackageOBJ.sidepanel.open(
                                "cooIssueDetailPopup",
                                "/issuecover/cooIssueCoverDetail" + getParam,
                                "1300px",
                                true
                            );
	        ...
	        this.bindEvent = function() {
	            $("#auto_create_yn").off("change").on("change", function() {
	                COO_MODIFY_POPUP.toggleCertifyNoInput();
	            });
	
	            $("#issue_date").off("change").on("change", function() {
	                COO_MODIFY_POPUP.syncCoverPeriodByIssueDate();
	            });
	        ...
	        this.autoCheckPriorityRows = function() {
	            var gridData = AUIGrid.getGridData(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01);
	            ...
	            AUIGrid.setCheckedRowsByIds(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01, checkedRowIds);
	            /* 배경색 즉시 반영 */
	            setTimeout(function() {
	                AUIGrid.refresh(COO_MODIFY_POPUP.grid_COO_MODIFY_POPUP_01);
	            }, 50);
	    ...
	    $(document).ready(function() {
	        COO_MODIFY_POPUP.Initialize_viewObject();
	    });
	</script>
</body>
</html>