...
<div id="content">
	<section id="widget-grid-DB00901" class="">
		<form:form id="DB00901-form" class="s4-form" novalidate="novalidate" onsubmit="return false;">
			...
			<input type="hidden" id="P_OVER_DRWBAK_PRESENTN_NO" name="P_OVER_DRWBAK_PRESENTN_NO"/>
			<div class="row">
...
<script type="text/javascript">
	...
	var DB00901 = new function() {
		...
		this.retrieve_Information_callback = function(result){
			...
			if(data.OVER_DRWBAK_PRESENTN_NO == undefined){
				KpackageOBJ.object.setFormValue("DB00901-form","WORK_TYPE", "I");
				
			}else{
				KpackageOBJ.object.setFormValue("DB00901-form","WORK_TYPE", "U");
				KpackageOBJ.object.setFormValue("DB00901-form", "P_OVER_DRWBAK_PRESENTN_NO",data["OVER_DRWBAK_PRESENTN_NO"]);
			}
		    ...
		    KpackageOBJ.object.setFormValue("DB00901-form", "PROPER_DRWBAK_AMOUNT",data["PROPER_DRWBAK_AMOUNT"]);
		    KpackageOBJ.object.setFormValue("DB00901-form", "OVER_DRWBAK_REMARK"  ,data["OVER_DRWBAK_REMARK"]);
		    KpackageOBJ.object.setFormValue("DB00901-form", "OVER_DRWBAK_REASON"  ,data["OVER_DRWBAK_REASON"]);
		    KpackageOBJ.object.setFormValue("DB00901-form", "RCEPT_COMPANY_NAME"  ,data["RCEPT_COMPANY_NAME"]);
		    KpackageOBJ.object.setFormValue("DB00901-form", "RCEPT_RPRSNTV_NM"    ,data["RCEPT_RPRSNTV_NM"]);
		    
		    
		    $("#DB00901-form #RCEPT_RPRSNTV_NM_FOOTER").html(data["RCEPT_RPRSNTV_NM"]);
		    
		    KpackageOBJ.object.setFormValue("DB00901-form", "ECTMRK"    ,data["ECTMRK"]);
		    KpackageOBJ.object.setFormValue("DB00901-form", "BIZRNO"    ,data["BIZRNO"]);
		    KpackageOBJ.object.setFormValue("DB00901-form", "ADDRESS"   ,data["ADDRESS"]);
		...
		this.createDocument = function(){
			...
			var documentValidation = KpackageOBJ.object.getFormValue("DB00901-form","WORK_TYPE");				   
			if("" == documentValidation || ("I" != documentValidation && "U" != documentValidation)){
				alert("문서의 상태값을 알 수 없습니다.");
				return false;
			}
	...
	$(document).ready(function() {
		...
		DB00901.initialize_viewObject();	// 화면에서 사용하는 Selelect Box, Calendar 등을 생성합니다.
		DB00901.initialize_TuiGrid();		// Toast Grid Render
