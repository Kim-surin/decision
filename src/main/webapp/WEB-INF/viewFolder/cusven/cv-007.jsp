...
<div id="content">
	<section id="widget-grid-CV007" class="">
		<form:form id="CV007-form" class="s4-form" novalidate="novalidate" action="/db-002" method="post">
			...
			<div class="row-extends row">
				<div class="col-xs-12 col-sm-11 col-md-11 col-lg-11">
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									<th><spring:message code='양도월' /></th>
									<td>
										<input type="text" id="DRWBAK_MONTH_FROM"  name="DRWBAK_MONTH_FROM" class="inputText has-month-picker" searchfnc="CV007.retrieve_CV007List"/>
										<span class="fromTo-Dash">~</span>
										<input type="text" id="DRWBAK_MONTH_TO"  name="DRWBAK_MONTH_TO" class="inputText has-month-picker" searchfnc="CV007.retrieve_CV007List"/>
									</td>
									<th><spring:message code='기납증접수번호' /></th>
									<td>
										<input type="text" id="REGIST_RCEPT_NO"  name="REGIST_RCEPT_NO" style="width:99%" class="inputText" maxlength="20" searchfnc="CV007.retrieve_CV007List"/>
									</td>
									<th><spring:message code='기납증제출번호' /></th>
									<td>
										<input type="text" id="SUBMIT_NO"  name="SUBMIT_NO" style="width:99%" class="inputText" maxlength="20" searchfnc="CV007.retrieve_CV007List"/>
									</td>
								</tr>
								<tr>
									<th><spring:message code='근거서류번호' /></th>
									<td>
										<input type="text" id="BASIS_DOC_NO"  name="BASIS_DOC_NO" style="width:99%" class="inputText" maxlength="20" searchfnc="CV007.retrieve_CV007List"/>
									</td>
				...
				<div class="col-xs-12 col-sm-1 col-md-1 col-lg-1">
					<div class="input-group-btn">
						<button class="btn btn-default btn-primary btn-custom-search search-row-2" type="button" onclick="javascript:CV007.retrieve_CV007List();">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div id="div_oTui_CV007_List" name="div_oTui_CV007_List" class="tuigrid-resizable">
					<div id="oTui_CV007_List" data-minus-height="310"></div>
					<div id="oTui_CV007_List_paging"></div>
				</div>
			</div>
		</div>
...
<div id="REQ_JURGE_DOC_LAYER" title="수신 결과" style="display: none; overflow: hidden;">
	<form:form id="CV007-REQ_DOC-form" class="s4-form" novalidate="novalidate" method="post">
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<label class="control-label">기납증심사 요구자료 문서번호</label>
			...
			<div class="row">
				<div class="col-md-12">
					<div style="width: 125px; float: right;">
						<button class="btn btn-default btn-primary btn-custom-search search-row-1" type="button" onclick="javascript:CV007.dataSaveFunction();">
...
<script>
	...
	var CV007 = new function(){
		...
		this.Initialize_viewObject = function() {
			...
			KpackageOBJ.monthPicker.create("CV007-form", "DRWBAK_MONTH_FROM");
			KpackageOBJ.monthPicker.setValue("CV007-form","DRWBAK_MONTH_FROM", KpackageOBJ.date.getCurrMonth("").replace(/-/gi, ""));
			
			KpackageOBJ.monthPicker.create("CV007-form", "DRWBAK_MONTH_TO");
			KpackageOBJ.monthPicker.setValue("CV007-form","DRWBAK_MONTH_TO", KpackageOBJ.date.getCurrMonth("").replace(/-/gi, ""));
			
						
			KpackageOBJ.calendar.create("CV007-form", "CAL_SEARCH_COMP_FROM_DATE");
			KpackageOBJ.calendar.create("CV007-form", "CAL_SEARCH_COMP_TO_DATE");
			KpackageOBJ.selectbox.create("CV007-form", "EXECUT_STATUS",  "/common/retrieveComCdList", {"CATEGORY_CD":"EXECUT_STATUS","OPTION_ALL":"Y"}, "CODE", "NAME");
		...
		this.renderTuiGrid = function() {
			...
			var colArrayInfo = [
			     ...
			     { header : "기납증제출번호"	,name : "SUBMIT_NO"			,width : 120, align: "center" ,hidden:false },
			     { header : "기납증접수번호"	,name : "REGIST_RCEPT_NO"	,width : 120, align: "center" ,hidden:false },
			     { header : "양도일자"   	,name : "CHIT_FRMTRM_DATE"	,width : 120, align: "center" ,hidden:false, "formatter" : KpackageOBJ.tuiGrid.dateFormatter },
			     { header : "HS Code"    	,name : "HS_CODE"			,width : 120, align: "center" ,hidden:false, "formatter" : KpackageOBJ.tuiGrid.hscode10 },
			     { header : "기납증 순번"   	,name : "SEQ"				,width : 120, align: "center" ,hidden:false },
			     { header : "제품코드"    	,name : "ITEM_CODE"			,width : 100, align: "center" ,hidden:false },
			     { header : "제품명"    	,name : "ITEM_NM"			,width : 250, align: "left"   ,hidden:false },
			     { header : "수량"    		,name : "ACCMLT_ORDER_QY"	,width : 120, align: "right"  ,hidden:false, "formatter" : KpackageOBJ.tuiGrid.commas },
			     { header : "단위"    		,name : "BASS_UNIT"			,width : 80, align: "center" ,hidden:false },
			     { header : "수출금액"    	,name : "STTEMNT_PC_KRW"	,width : 120, align: "right"  ,hidden:false, "formatter" : KpackageOBJ.tuiGrid.commas },
			     { header : "통화코드"    	,name : "KRW_CRNCY"			,width : 80, align: "center" ,hidden:false },
			     { header : "서류구분"    	,name : "SUPT_DOC_SE_NAME"	,width : 80, align: "center" ,hidden:false },
			     { header : "근거서류"    	,name : "BASIS_DOC_NO"		,width : 80, align: "center" ,hidden:false },
			     { header : "근거서류순번"   	,name : "SUPT_DOC_ITEM_SEQ"	,width : 80, align: "center" ,hidden:false },
			     { header : "신고서 작성여부" ,name : "DOC_WRITE_YN"		,width : 120, align: "center" ,hidden:false },
			     ...
			     { header : "전송상태"    	,name : "VALID_CODE"		,width : 200, align: "center" ,hidden:false, formatter : CV007.transStatus_CustomFormatter },
			];
			 
			  
			 var tools = [{icon:"print", title:"자재명세서(BOM)" 		,text:"양식출력" 				,func:"CV007.openPrintReport"}
						  ,{icon:"none",  title:"입력" 				,text:"요구자료 정보입력" 		,func:"CV007.inputReqJurgeDocNo"}
						  ,{icon:"none",  title:"전송" 				,text:"전송" 					,func:"CV007.sendInterface"}
						  ,{icon:"none",  title:"수신" 				,text:"수신" ,func:"CV007.receiveUnipass"}
						  ,{icon : "none",header : "상태조회"			,text : "상태조회",func : "CV007.unipassStatusPopup"}
						  
				];
			 KpackageOBJ.tuiGrid.setButton("oTui_CV007_List", tools); // Toobar 생성
			 KpackageOBJ.tuiGrid.create("oTui_CV007_List", "/drawback/retrieve_CV007List", colArrayInfo, 'checkbox', CV007.oTui_CV007_List_onClick_Handler, CV007.oTui_CV007_List_onDblclick_Handler );
			 
		}
		
		this.oTui_CV007_List_onClick_Handler  = function(p_GridId, p_RowKey, p_ColName){}
		
		this.oTui_CV007_List_onDblclick_Handler = function(p_GridId, p_RowKey, p_ColName){
			//CV007.openDetailPage(p_RowKey);
		}
		
		/**  조회버튼 클릭 */
		this.retrieve_CV007List = function() {
			var param = KpackageOBJ.data.makePostData("CV007-form");  
			
			KpackageOBJ.tuiGrid.retrieve("oTui_CV007_List", "", param);
		...
		this.openPrintReport = function(){
	    	...
	    	var rowData = KpackageOBJ.tuiGrid.getCheckedRows("oTui_CV007_List");
		...
		this.sendInterface = function(){
            ...
            KpackageOBJ.ajax.doSubmit("/drawbackDoc/createXml_InitBom", rowData, CV007.sendInterface_callback);
		}
		...
		this.sendInterface_callback = function(result){
            ...
            if (data.length > 0) {
                ...
                KpackageOBJ.ajax.doSubmit("/drawbackDoc/updateBomSubmitStatus", data, CV007.updateBomSubmitStatus_callback);
		...
		this.updateBomSubmitStatus_callback = function(result){
			if(result.success){
			    ...
			    CV007.unipassSendResult(result.message);
			}
			CV007.retrieve_CV007List();
		...
		*/
		this.inputReqJurgeDocNo = function(resultMsg) {
            ...
            KpackageOBJ.object.setFormValue("CV007-REQ_DOC-form","REQ_DOC_NO", rowData[0]["REQ_DOC_NO"]);
			KpackageOBJ.object.setFormValue("CV007-REQ_DOC-form","REQ_DOC_LINE_NO", rowData[0]["REQ_DOC_LINE_NO"]);
        }
		
		this.dataSaveFunction = function() {
		    var rowData = KpackageOBJ.tuiGrid.getCheckedRows("oTui_CV007_List");
		    KpackageOBJ.object.setFormValue("CV007-REQ_DOC-form","BOM_PRESENTN_NO", rowData[0]["BOM_PRESENTN_NO"]);
		    KpackageOBJ.object.setFormValue("CV007-REQ_DOC-form","PRESENTN_NO", rowData[0]["PRESENTN_NO"]);
		    KpackageOBJ.object.setFormValue("CV007-REQ_DOC-form","XPORT_STTEMNT_NO", rowData[0]["XPORT_STTEMNT_NO"]);
		    KpackageOBJ.object.setFormValue("CV007-REQ_DOC-form","LNE_NO", rowData[0]["LNE_NO"]);
		    KpackageOBJ.object.setFormValue("CV007-REQ_DOC-form","POUCH_NO", rowData[0]["POUCH_NO"]);

		    var postData = KpackageOBJ.data.makePostData("CV007-REQ_DOC-form");
		    postData["REQ_DOC_NO"] = KpackageOBJ.object.getFormValue("CV007-REQ_DOC-form","REQ_DOC_NO");
		    postData["REQ_DOC_LINE_NO"] = KpackageOBJ.object.getFormValue("CV007-REQ_DOC-form","REQ_DOC_LINE_NO");
		    postData["SEQ"] = rowData[0]["SEQ"];
			KpackageOBJ.ajax.doSubmit("/drawbackDoc/createMerge_InitBomSubmitData", postData, "CV007.dataSaveFunction_CallbackHandler");
		};
		...
		this.transStatus_CustomFormatter = function(value){
			...
			return "<a class='btn "+btnClass+" btn-border tuiGrid-toolbar-freeColor-button' style='"+btnStyle+"'"  
			+ " href=\"javascript:CV007.transStatusDetail('"+rowData["PRESENTN_NO"]+"');\" title=\"상세내용 확인하려면 클릭하세요\">" + buttonText + '</a>';	
		}
		
		this.transStatusDetail = function() {
			KpackageOBJ.tuiGrid.uncheckAll("oTui_CV007_List");
			KpackageOBJ.tuiGrid.check("oTui_CV007_List",KpackageOBJ.tuiGrid.getSelectedRowKey("oTui_CV007_List"));
			CV007.unipassStatusPopup();
		}
		
		this.unipassStatusPopup = function() {
            var rowDatas = KpackageOBJ.tuiGrid.getCheckedRows("oTui_CV007_List");
	...
	$(document).ready(function() {
		...
		CV007.Initialize_viewObject();		// 화면에서 사용하는 Selelect Box, Calendar 등을 생성합니다.
		CV007.renderTuiGrid();
	});
