...
<div id="content">
	<section id="widget-grid" class="">
		<form:form id="SV002-search-form" novalidate="novalidate" class="s4-form" onsubmit="return false;" method="post">
			<div class="row-extends row">
				...
				<div class="col-xs-12 col-sm-1 col-md-1 col-lg-1">
					<div class="input-group-btn">
						<button class="btn btn-default btn-primary btn-custom-search search-row-1" type="button" onclick="javascript:SV002.retrieve_gridData();">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		SV002.initialize_Object(); 		// 화면에서 사용하는 Selelect Box, Calendar 등을 생성합니다.
		SV002.initialize_TuiGrid();		 
