...
<div class="content-wrapper">
    <form id="ItemDetailPopup-form" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-12">
                <div style="display:flex; justify-content:flex-end; align-items:center; margin-bottom:10px;">
                    <button type="button" class="btn btn-sm btn-primary waves-effect waves-themed" onclick="ItemDetailPopup.save();" style="width:90px; height:32px;"><spring:message code="TXT.SAVE"/></button>
                </div>
            </div>
        </div>
        <!-- 제품 기본정보 -->
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="row" style="margin-bottom:15px;">
                        <div class="col-2">
                            <label class="form-label" for="ITEM_CODE_DISPLAY"><spring:message code="TXT.PRODUCT_CODE"/></label>
                        </div>
                        <div class="col-4">
                            <input type="text" class="form-control" id="ITEM_CODE_DISPLAY" readonly style="width:100%;">
                        </div>
                        <div class="col-2">
                            <label class="form-label" for="ITEM_NAME"><spring:message code="TXT.MATERIAL_NAME"/></label>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="row" style="margin-bottom:15px;">
                        <div class="col-2">
                            <label class="form-label" for="CURRENT_PRODUCT_LINE_CODE"><spring:message code="TXT.REGISTERED_PRODUCT_GROUP_CODE"/></label>
                        </div>
                        <div class="col-4">
                            <input type="text" class="form-control" id="CURRENT_PRODUCT_LINE_CODE" readonly style="width:100%;">
                        </div>
                        <div class="col-2">
                            <label class="form-label" for="CURRENT_PRODUCT_LINE_NAME"><spring:message code="TXT.REGISTERED_PRODUCT_GROUP_NAME"/></label>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <label class="form-label" for="SELECTED_PRODUCT_LINE_CODE"><spring:message code="TXT.PRODUCT_GROUP_CODE_TO_MODIFY"/></label>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-2">
                            <label class="form-label" for="SELECTED_PRODUCT_LINE_NAME"><spring:message code="TXT.PRODUCT_GROUP_NAME_TO_MODIFY"/></label>
                        </div>
                        <div class="col-4">
        ...
        <div class="panel panel-icon">
            <div class="panel-container show">
                <div class="panel-content">
                    <div style="font-size:15px; font-weight:700; margin-bottom:15px;"><spring:message code="TXT.PRODUCT_IMAGE"/></div>
                    <div class="row">
                        <div class="col-2">
                            <label class="form-label" for="ITEM_IMG"><spring:message code="TXT.PRODUCT_IMAGE"/></label>
                        </div>
                        <div class="col-10">
        ...
        <div class="panel panel-icon">
            <div class="panel-container show">
                <div class="panel-content">
                    <div style="font-size:15px; font-weight:700; margin-bottom:15px;"><spring:message code="TXT.PRODUCT_GROUP_MANAGEMENT"/></div>
                    <div class="row" style="margin-bottom:15px;">
                        <div class="col-2">
                            <label class="form-label" for="GROUP_PRODUCT_CODE"><spring:message code="TXT.PRODUCT_GROUP_CODE"/></label>
                        </div>
                        <div class="col-10">
                    ...
                    <div class="row" style="margin-bottom:15px;">
                        <div class="col-2">
                            <label class="form-label" for="GROUP_PRODUCT_NAME"><spring:message code="TXT.PRODUCT_GROUP_NAME"/></label>
                        </div>
                        <div class="col-10">
                    ...
                    <div class="row" style="margin-bottom:15px;">
                        <div class="col-2">
                            <label class="form-label" for="FLOWCHART_COMMENT"><spring:message code="TXT.MANUFACTURING_PROCESS_ORDER"/></label>
                        </div>
                        <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <label class="form-label"><spring:message code="TXT.FLOWCHART_ATTACHMENT"/></label>
                        </div>
                        <div class="col-10">
...
var ItemDetailPopup = new function() {
    ...
    this.save = function() {
        ...
        if (!selectedProductLineCode) {
            alert("<spring:message code='MSG.SELECT_PRODUCT_GROUP_CODE_TO_MODIFY' javaScriptEscape='true'/>");
