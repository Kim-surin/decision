                        ...
                        <div class="panel-content" style="padding:20px 32px;">
                            ...
                            <div style="display:grid; grid-template-columns:420px 340px 1fr; column-gap:36px; align-items:end;">
                                ...
                                <div>
                                    ...
                                    <label class="form-label" for="individual_search_type" style="display:block; margin-bottom:8px;"><spring:message code='TXT.SEARCH_TYPE'/></label>

                                    <div style="display:flex; align-items:center; gap:10px;">

                                        <select class="form-select" id="individual_search_type" name="search_type" style="width:120px;">

                                            <option value="ITEM"><spring:message code='TXT.MATERIAL'/></option>

										    <option value="ORDER_NO"><spring:message code='TXT.ORDER_NO'/></option>
                                ...
                                <div>
                                    ...
                                    <label class="form-label" for="individual_search_from_date" style="display:block; margin-bottom:8px;"><spring:message code='TXT.ARRIVAL_DATE'/></label>
                            ...
                            <div id="individualCootargetList_SEARCHMORE" style="display:none; margin-top:20px; padding-top:20px; border-top:1px solid #e5e5e5;">
                                ...
                                <div style="display:grid; grid-template-columns:420px 340px 100px; column-gap:36px; align-items:end;">
                                    ...
                                    <div>
                                        ...
                                        <label class="form-label" for="individual_plant" style="display:block; margin-bottom:8px;"><spring:message code='TXT.PLANT'/></label>
                                    ...
                                    <div>
                                        ...
                                        <label class="form-label" for="individual_warehousing_type" style="display:block; margin-bottom:8px;"><spring:message code='TXT.DOMESTIC'/>/<spring:message code='TXT.IMPORT'/></label>

										<select class="form-select" id="individual_warehousing_type" name="warehousing_type" style="width:200px;">

										    <option value="">All</option>

										    <option value="DOM"><spring:message code='TXT.DOMESTIC'/></option>

										    <option value="IMP"><spring:message code='TXT.IMPORT'/></option>
            ...
            <div class="col-5">
                ...
                <div class="frame-wrap">
                    ...
                    <div class="demo" style="display:flex; justify-content:flex-end; align-items:center; gap:3px;">
                        ...
                        <button type="button" class="btn btn-sm btn-secondary waves-effect waves-themed" onclick="individualCootargetList.openWritePopup();" style="width:110px; color:#fff; background-color:#526d82; border:1px solid #526d82;"><spring:message code='TXT.CREATE_CERTIFICATE'/></button>
...
var individualCootargetList = new function() {
    ...
    this.createAUIGrid = function() {
        ...
        const columnLayout = [
        	...
        	{dataField:"DIVISION_NAME", headerText:"<spring:message code='TXT.PLANT' javaScriptEscape='true'/>", width:140, filter:{showIcon:false}, style:"aui-center-align"},

        	{dataField:"VENDOR_NAME", headerText:"<spring:message code='TXT.VENDOR_NAME_GRID' javaScriptEscape='true'/>", width:200, filter:{showIcon:true}, style:"aui-center-align"},

        	{dataField:"ITEM_CODE", headerText:"<spring:message code='TXT.ITEM_CODE2' javaScriptEscape='true'/>", width:200, filter:{showIcon:true}, style:"aui-center-align"},

        	{dataField:"ITEM_NAME", headerText:"<spring:message code='TXT.MATERIAL_NAME_GRID' javaScriptEscape='true'/>", width:"auto", filter:{showIcon:true}, style:"aui-left-align"},

        	{dataField:"HS_CODE", headerText:"HSCode", width:140, filter:{showIcon:false}, style:"aui-center-align"},

        	{dataField:"ORDER_NO", headerText:"<spring:message code='TXT.ORDER_NO' javaScriptEscape='true'/>", width:140, filter:{showIcon:false}, style:"aui-center-align"},

        	{dataField:"ORDER_SEQ", headerText:"<spring:message code='TXT.ORDER_SEQ' javaScriptEscape='true'/>", width:100, filter:{showIcon:false}, style:"aui-center-align"},

        	{dataField:"SUBMIT_STATUS", headerText:"<spring:message code='TXT.STATUS' javaScriptEscape='true'/>", width:100, filter:{showIcon:false}, style:"aui-center-align"},
    ...
    $.ajax({
        ...
        error:function(xhr, status, error) {
            ...
            console.log("<spring:message code='MSG.LIST_RETRIEVE_ERROR' javaScriptEscape='true'/>");
    ...
    $.ajax({
        ...
        error:function(xhr, status, error) {
            ...
            console.log("<spring:message code='MSG.DASHBOARD_RETRIEVE_ERROR' javaScriptEscape='true'/>");
    ...
    this.excelDownload = function() {
        ...
        const exportProps = {
            ...
            fileName:"<spring:message code='TXT.CERTIFICATE_OF_ORIGIN_REGISTRATION' javaScriptEscape='true'/>",
    ...
    this.openWritePopup = function() {
        ...
        if (!orderNo || !orderSeq) {
            ...
            alert("<spring:message code='MSG.SELECTED_MATERIAL_ORDER_INFO_NOT_FOUND' javaScriptEscape='true'/>");
        ...
        if (invalid) {
        	...
        	alert("<spring:message code='MSG.SELECT_SAME_ORDER_VENDOR_PLANT_CERTIFICATE_STATUS' javaScriptEscape='true'/>");
        ...
        KpackageOBJ.dialog.open(
            ...
            "<spring:message code='TXT.CREATE_CERTIFICATE' javaScriptEscape='true'/>",
