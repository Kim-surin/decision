...
var AUIGridMessages = {
    ...
    /* AUI GRID 메세지 공통 텍스트 */
    MSG_GRDTOOLTIPCOPIED: 'Copied to Clipboard',
    DROP_DOWN_PASTE_VALIDATION: 'You pasted data that was not in the dropdown.',
    MSG_INVALID_NUMBER_ONLY_PLUS: 'Only positive numbers are allowed.',
    MSG_NOT_NUMBER_VALUE: 'Only numeric values are allowed.',
    MSG_EXCEEDED_ALLOWED_INT_LENGTH: 'A fixed number of decimal places exists. The maximum integer you can enter is #{intLength} digits.',
    MSG_EXCEEDED_ALLOWED_TOTAL_LENGTH: 'The maximum number of digits allowed (including both integer and decimal parts) is 16.',
    MSG_EXCEEDED_ALLOWED_LENGTH:
        'You have exceeded the allowed number of digits.(Maximum: #{int_length} digits for the integer part, #{dec_length} digits for the decimal part.)',
    MSG_ALLOW_ZERO_TO_HUNDRED: 'Only numbers between 0 and 100 are allowed.',
    MSG_INVALID_DATE_RANGE: 'Only values between #{start_date} and #{end_date} are allowed..',
};
