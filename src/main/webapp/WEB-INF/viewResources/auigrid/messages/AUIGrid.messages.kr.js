...
var AUIGridMessages = {
    ...
    /* AUI GRID 메세지 공통 텍스트 */
    MSG_GRDTOOLTIPCOPIED: '클립보드에 복사되었습니다.',
    DROP_DOWN_PASTE_VALIDATION: '드롭다운에 없는 데이터를 붙여넣기 하였습니다.',
    MSG_INVALID_NUMBER_ONLY_PLUS: '양수만 입력 가능합니다.',
    MSG_NOT_NUMBER_VALUE: '숫자 형식의 값만 입력 가능합니다.',
    MSG_EXCEEDED_ALLOWED_INT_LENGTH: '고정 소수점자릿수가 존재합니다. 입력가능한 최대 정수는 #{intLength} 자리 입니다.',
    MSG_EXCEEDED_ALLOWED_TOTAL_LENGTH: '입력가능한 숫자의 최대 개수는 16개입니다.(정수+소수)',
    MSG_EXCEEDED_ALLOWED_LENGTH: '허용되는 자리수를 초과하였습니다.(정수 #{int_length} 자리, 소수 #{dec_length} 자리)',
    MSG_ALLOW_ZERO_TO_HUNDRED: '0에서 100까지의 숫자만 입력 가능합니다.',
    MSG_INVALID_DATE_RANGE: '#{start_date}부터 #{end_date} 사이의 값만 입력 가능합니다.',
};
