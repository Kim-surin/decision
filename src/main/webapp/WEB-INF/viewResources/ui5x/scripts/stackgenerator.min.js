                        ...
                        <div class="icon-settings d-flex flex-column flex-grow-1 border-start px-2 py-2 pe-4">
                            <div class="d-flex justify-content-between align-items-center flex-grow-1">
                                ...
                                <div class="layer-actions d-flex gap-1">
                                    ...
                                    <button class="btn btn-icon btn-outline-secondary edit-layer p-1 w-auto h-auto border-0" data-layer="${t}">
                                        <i class="sa sa-reload"></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-secondary tune-layer p-1 w-auto h-auto border-0 " data-layer="${t}" data-bs-toggle="collapse" data-bs-target="#layer-controls-${t}" aria-expanded="false">
                                        <i class="sa sa-settings"></i>
                                    </button>
                                    <button class="btn btn-icon btn-outline-danger delete-layer p-1 w-auto h-auto border-0" data-layer="${t}">
                        ...
                        <div class="control-panel-content shadow-inset-2 px-3 pt-1 pb-3" onclick="event.stopPropagation();">
                            ...
                            <div>
                                ...
                                <div class="d-flex flex-wrap gap-1">
                                    <button class="btn btn-icon btn-outline-default color-btn ${d?"":"active"}" data-color="" data-layer="${t}">
                                        <i class="sa sa-ban"></i>
                                    </button>
                                    <button class="btn btn-icon btn-primary color-btn ${"primary"===d?"active":""}" data-color="primary" data-layer="${t}"></button>
                                    <button class="btn btn-icon btn-secondary color-btn ${"secondary"===d?"active":""}" data-color="secondary" data-layer="${t}"></button>
                                    <button class="btn btn-icon btn-success color-btn ${"success"===d?"active":""}" data-color="success" data-layer="${t}"></button>
                                    <button class="btn btn-icon btn-danger color-btn ${"danger"===d?"active":""}" data-color="danger" data-layer="${t}"></button>
                                    <button class="btn btn-icon btn-warning color-btn ${"warning"===d?"active":""}" data-color="warning" data-layer="${t}"></button>
                                    <button class="btn btn-icon btn-info color-btn ${"info"===d?"active":""}" data-color="info" data-layer="${t}"></button>
                                    <button class="btn btn-icon btn-dark color-btn ${"dark"===d?"active":""}" data-color="dark" data-layer="${t}"></button>
                                    <button class="btn btn-icon btn-default color-btn ${"light"===d?"active":""}" data-color="light" data-layer="${t}"></button>
                                </div>
                            </div>
                        </div>
                    </div>
