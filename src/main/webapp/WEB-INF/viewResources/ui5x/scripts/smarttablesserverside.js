...
document.addEventListener('DOMContentLoaded', () => {
  ...
  let columnDefs = [{
    ...
    render: function (value) {
      ...
      return shouldBeRed ? `<span class="text-danger fw-bold">${formattedBonus}</span>` : formattedBonus;
    }
  }, {
    data: "performance",
    title: "Performance",
    render: function (value) {
      ...
      return '<div class="progress" style="height: 20px;">' + '<div class="progress-bar ' + progressClass + '" ' + 'role="progressbar" ' + 'data-width="' + performance + '" ' + 'aria-valuenow="' + performance + '" ' + 'aria-valuemin="0" ' + 'aria-valuemax="100" ' + 'style="width: ' + performance + '%;">' + performance + '%' + '</div>' + '</div>';
    }
  }, {
    data: "department",
    title: "Department"
    ...
    render: function (value) {
      ...
      let barColor = hours > 40 ? "bg-danger" : hours > 20 ? "bg-warning" : "bg-success";
      return `
