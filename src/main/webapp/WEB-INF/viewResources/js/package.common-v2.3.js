...
function checkURL(e) {
	...
	if (url) {
	    ...
	    if($("#"+pageLayerId).length < 1){
			/* Content Layer  생성 */
			$("main.app-body").append("<div id=\""+pageLayerId+"\" class=\"app-content\"></div>");
			container = $("#"+pageLayerId);
			$("#"+pageLayerId).show();
			/* Tab Button 생성 */
			$("#mainPage_tab li").removeClass("active");
			var tabObj = "<li id=\""+tabButttonId+"\" name=\"header_tab\" class=\"nav-item active\" role=\"presentation\">";
			tabObj = tabObj + "<a class=\"nav-link\" href=\"javascript:tabChange(this, '"+pageLayerId+"')\" style=\"float: left;\">"+menu_title+" </a>"; 
			tabObj = tabObj + "<a class=\"nav-link\" href=\"javascript:tabClose('"+pageLayerId+"')\" style=\"padding: 0px;padding-right: 2px;\">x</a>";
			tabObj = tabObj + "</li>";
		    ...
		    $("#"+pageLayerId).show();
		    $("#"+pageLayerId).css({opacity : '0.0'}).delay(50).animate({opacity : '1.0'}, 300);
...
function tabChange(thisObj, contId){
    ...
    $("#"+contId).show();
    $("#"+contId).css({opacity : '0.0'}).delay(50).animate({opacity : '1.0'}, 300);
}
