CREATE OR REPLACE PACKAGE BODY PKG99_COO_CTC_DECISION AS

    /******************************************************************************/
    /* Project      : FTA PROJECT (K-ORIGIN)                                      */
    /* Module       : PROC99_COO_DECISION                                         */
    /* Program Name : PROC99_COO_DECISION.SQL                                     */
    /* Description  : 원산지 판정                                                 */
    /*                                                                            */
    /* Program History                                                            */
    /*----------------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------------*/
    /* 2011/11/10  TOMBOW          Initial Version                                */
    /* 2012/04     jsPark          SE에 맞게 수정                                 */
    /*                                                                            */
    /* Reference by :                                                             */
    /******************************************************************************/
    ...
    /*
    ******************************************************************************
    * PROCEDURE NAME : COO_DECISION
    *    DESCRIPTION : FCR MASTER 및  FTA_BOM_DTL 기준으로 판정을 수행한다
    *                  판정은 FCR MASTER 한건에 대해 FTA별로 판정을 수행한다
    *
    *****************************************************************************
    */
    ...
    BEGIN
        ...
        --DBMS_OUTPUT.PUT_LINE('PKG99_COO_CTC_DECISION Start..');



        -- 프로시저 로그 저장
        PKG00_PROCEDURE_LOG.BATCH_LOG(VG_LOG_ID, TO_CHAR(SYSDATE, 'YYYYMMDD'), 'PKG99_COO_CTC_DECISION', 'S', P_COMPANY_CODE, 'INPUT DATA : ' ||
                                       P_COMPANY_CODE || ':' ||
                                       P_SALES_NO);

        PKG00_PROCEDURE_LOG.BATCH_LOG_DTL(VG_LOG_ID, 'START PKG99_COO_CTC_DECISION *****');
        ...
        */
            ...
            */
            ...
            LOOP
                ...
                */
                ...
                VG_FRD_REC.CREATE_BY   := 'PKG99_COO_CTC_DECISION';
                VG_FRD_REC.UPDATE_DATE := SYSDATE;
                VG_FRD_REC.UPDATE_BY   := 'PKG99_COO_CTC_DECISION';
        ...
        --DBMS_OUTPUT.PUT_LINE('PKG99_COO_CTC_DECISION : End Of Procedure');
        PKG00_PROCEDURE_LOG.BATCH_LOG_DTL(VG_LOG_ID, '***** END PKG99_COO_CTC_DECISION');
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUES
                ...
                ,'N' -- DELETE_YN
                ,SYSDATE -- CREATE_DATE
                ,'PKG99_COO_CTC_DECISION' -- CREATE_BY
                ,SYSDATE -- UPDATE_DATE
                ,'PKG99_COO_CTC_DECISION' -- UPDATE_BY
